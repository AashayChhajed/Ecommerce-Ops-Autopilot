...
test('serializes database rows into the public API shape', () => {
  const product = toApiProduct({ id: '1', shopify_product_id: '2', title: 'Mug', inventory: '4', price: '9.99', created_at: '2026-01-01', updated_at: '2026-01-02' });
  assert.deepEqual(product, { id: 1, shopifyProductId: 2, title: 'Mug', description: undefined, vendor: undefined, status: undefined, inventory: 4, price: 9.99, createdAt: '2026-01-01', updatedAt: '2026-01-02' });
});
